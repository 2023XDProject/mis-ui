      ...
      <section class="form_contianer" v-show="showLogin">
        <el-form :model="loginForm" :rules="rules" ref="loginForm">
          ...
          <el-form-item prop="username">
            <el-input v-model="Studentdto.stuID" placeholder="用户名"
...
export default {
  ...
  methods: {
    ...
    // },
    async register() {
      if(this.Studentdto.pwd===this.Student.pwd2){
        alert("相等");
      this.myPost("/user/register", this.Studentdto, (response) => {
        if (response.code === "200000") {
          alert("登录成功");
